    ...
    <div className="min-h-screen flex items-center justify-center bg-[#fdfbf7] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full glass-card p-8 rounded-3xl">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-stone-600">Sign in to manage your invitations</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-stone-900 hover:bg-gold-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500 transition-all disabled:opacity-50"
          >
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-stone-500 rounded-full">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 border border-stone-200 rounded-xl shadow-sm text-sm font-medium text-stone-700 bg-white hover:bg-stone-50 transition-colors"
            >
